...
import { Home, User, LogOut, Plus, Moon, Sun } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">StayFinder</span>
          </Link>
                ...
                {user?.isHost && (
                  <>
                    ...
                    <Link
                      ...
                      className="flex items-center space-x-1 bg-blue-600 dark:bg-blue-700 text-white px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors"
                    >
